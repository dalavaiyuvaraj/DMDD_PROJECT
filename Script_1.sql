...
GRANT SELECT ON ALL_BUILDING_NAMES TO COMPANY_ADMIN;
GRANT SELECT ON COMPANY_BUILDINGS TO COMPANY_ADMIN;
GRANT SELECT ON BUILDING_DETAILS_VIEW TO COMPANY_ADMIN;
GRANT SELECT ON TENANTS_INFO TO COMPANY_ADMIN;
GRANT SELECT ON MAINTENANCE_REQUESTS_INFO TO COMPANY_ADMIN;
GRANT SELECT ON MAINTENANCE_PERSONNEL_INFO TO COMPANY_ADMIN;
GRANT SELECT ON LEASE_INFO_VIEW TO COMPANY_ADMIN;

GRANT SELECT ON LEASE_INFO_VIEW TO TENANT;
GRANT SELECT ON MAINTENANCE_REQUESTS_INFO TO TENANT;

GRANT SELECT ON ALL_BUILDING_NAMES TO PROSPECTIVE_TENANT;
